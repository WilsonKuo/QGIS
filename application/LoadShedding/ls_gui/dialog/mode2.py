...
class mode2_ExecDialog(QtWidgets.QDialog):
    def __init__(self, parent=None):
        super(mode2_ExecDialog, self).__init__(parent)
        self.resize(220,100)
        self.setWindowTitle("Rotating")
        self.args = None
        ...
        validator = QtGui.QRegExpValidator(regexRule, self.groups)
        self.groups.setValidator(validator)
        self.groups.setPlaceholderText("A,B or A-B")
...
class mode2_StopDialog(QtWidgets.QDialog):
    def __init__(self, parent, pool):
        super(mode2_StopDialog, self).__init__(parent)
        self.setFixedSize(220,80)
        self.setWindowTitle("[Stop] Rotating")
        self.args  = None
        self.pool  = pool
